...
<p align="center">
  <img src="screenshots/phase-d/D1-custom-rules-dashboard.png" alt="Custom Detection Rules Dashboard" width="90%">
</p>
<p align="center"><em>Custom detection rules firing in Wazuh — 10 MITRE ATT&CK-mapped rules with real alert data</em></p>

<p align="center">
  <img src="screenshots/phase-d/D2-mitre-attack-heatmap.png" alt="MITRE ATT&CK Heatmap" width="90%">
</p>
